...
% 
m24r=m24r(end-nPast+1:end);
alpha_m24=alpha_m24(:,end-nPast+1:end);

m42r=m42r(end-nPast+1:end);
alpha_m42=alpha_m42(:,end-nPast+1:end);

h24r=h24r(end-nPast+1:end);
alpha_h24=alpha_h24(:,end-nPast+1:end);
...
load(['puff_10IPRs_IP3_01uM_6s_',num2str(ldf)])
